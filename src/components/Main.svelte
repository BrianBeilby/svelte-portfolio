<script>
  ...
  let steps = [
    { name: "SakuraBot", icon: "fa-solid fa-robot" },
    { name: "IEEE Web App", icon: "fa-solid fa-building" },
...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    <div
      class="flex flex-col lg:justify-center text-0center lg:text-left gap-6 md:gap-8 lg:gap-10"
    >
      <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
        Hi! I'm <span class="poppins text-violet-400">Brian</span> Beilby
        <br />Full Stack <span class="poppins text-violet-400">Devevloper</span>
      </h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
      <Step step={steps[0]}>
        <p>
          ...
          > Commerce.js is a product CMS and Stripe is used for all transaction ahndling.
        </p>
      </Step>
      <Step step={steps[1]}>
        <p>
